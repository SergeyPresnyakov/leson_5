...
while True:
    try:
        number = input("Введите число для заполнени списка или 'stop' для окончания ввода: ")
        if number.isdigit():
            list.append(int(number))
        elif number == "stop":
            break
        else:
            raise Number("Вы ввели не число. Введите число")
...
print("Список чисел который вы сформировали: ", list)
